  ...
  return (
    <div className="bg-slate-50">
      <section id="services" className="container py-10 space-y-4 max-w-[1000px] pb-32">
        <h2 className="text-3xl">Fleet Sync LLC Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{' '}
          <a href="https://fleetsync.online">https://fleetsync.online</a> and any related services provided by Fleet
          Sync LLC.
        </p>
        <p>
          By accessing <a href="https://fleetsync.online">https://fleetsync.online</a>, you agree to abide by these
          Terms of Service and to comply with all applicable laws and regulations. If you do not agree with these Terms
          of Service, you are prohibited from using or accessing this website or using any other services provided by
          Fleet Sync LLC.
        </p>
        <p>
          We, Fleet Sync LLC, reserve the right to review and amend any of these Terms of Service at our sole
        ...
        <p>These Terms of Service were last updated on August 14, 2024.</p>
        <h3 className="text-2xl">Limitations of Use</h3>
        <p>
        ...
        <ul className="list-disc list-inside pl-2">
          ...
          <li>
            ...
            our networks or any other service Fleet Sync LLC provides;
          </li>
          <li>
        ...
        <h3 className="text-2xl">Intellectual Property</h3>
        <p>
          The intellectual property in the materials contained in this website are owned by or licensed to Fleet Sync
          LLC and are protected by applicable copyright and trademark law. We grant our users permission to download one
        ...
        <p>
          ...
          if you violate any of these restrictions or the Terms of Service, and may be terminated by Fleet Sync LLC at
          any time.
        </p>
        <h3 className="text-2xl">Liability</h3>
        <p>
          Our website and the materials on our website are provided on an 'as is' basis. To the extent permitted by law,
          Fleet Sync LLC makes no warranties, expressed or implied, and hereby disclaims and negates all other
        ...
        <p>
          In no event shall Fleet Sync LLC or its suppliers be liable for any consequential loss suffered or incurred by
          you or any third party arising from the use or inability to use this website or the materials on this website,
          even if Fleet Sync LLC or an authorized representative has been notified, orally or in writing, of the
          possibility of such damage.
        </p>
        <p>
          In the context of this agreement, &quot;consequential loss&quot; includes any consequential loss, indirect
          loss, real or anticipated loss of profit, loss of benefit, loss of revenue, loss of business, loss of
          goodwill, loss of opportunity, loss of savings, loss of reputation, loss of use and/or loss or corruption of
        ...
        <h3 className="text-2xl">Accuracy of Materials</h3>
        <p>
          The materials appearing on our website are not comprehensive and are for general information purposes only.
          Fleet Sync LLC does not warrant or make any representations concerning the accuracy, likely results, or
        ...
        <p>
          Fleet Sync LLC has not reviewed all of the sites linked to its website and is not responsible for the contents
          of any such linked site. The inclusion of any link does not imply endorsement, approval or control by Fleet
          Sync LLC of the site. Use of any such linked site is at your own risk and we strongly advise you make your own
          investigations with respect to the suitability of those sites.
        </p>
        <h3 className="text-2xl">Right to Terminate</h3>
        <p>
        ...
        <h3 className="text-2xl">Severance</h3>
        <p>
        ...
        <p>
          These Terms of Service are governed by and construed in accordance with the laws of Islamabad, Pakistan. You
