  ...
  return (
    <div className="bg-slate-50">
      <section id="services" className="container py-10 space-y-4 max-w-[1000px] pb-32">
        <h2 className="text-3xl">FleetSync LLC Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{' '}
          <a href="https://fleetsync.online">https://fleetsync.online</a> and any related services provided by FleetSync
          LLC.
        </p>
        <p>
        ...
        <p>
          We, FleetSync LLC, reserve the right to review and amend any of these Terms of Service at our sole discretion.
        ...
        <ul className="list-disc list-inside pl-2">
          ...
          <li>
            ...
            our networks or any other service FleetSync LLC provides;
          </li>
          <li>
        ...
        <p>
          The intellectual property in the materials contained in this website are owned by or licensed to FleetSync LLC
          and are protected by applicable copyright and trademark law. We grant our users permission to download one
        ...
        <p>
          ...
          if you violate any of these restrictions or the Terms of Service, and may be terminated by FleetSync LLC at
          any time.
        </p>
        ...
        <p>
          ...
          FleetSync LLC makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties
        ...
        <p>
          In no event shall FleetSync LLC or its suppliers be liable for any consequential loss suffered or incurred by
          you or any third party arising from the use or inability to use this website or the materials on this website,
          even if FleetSync LLC or an authorized representative has been notified, orally or in writing, of the
        ...
        <p>
          ...
          FleetSync LLC does not warrant or make any representations concerning the accuracy, likely results, or
        ...
        <p>
          FleetSync LLC has not reviewed all of the sites linked to its website and is not responsible for the contents
          of any such linked site. The inclusion of any link does not imply endorsement, approval or control by
          FleetSync LLC of the site. Use of any such linked site is at your own risk and we strongly advise you make
